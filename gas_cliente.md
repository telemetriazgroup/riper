...
Sin proceso: además se ocultan picos esporádicos (isla ≤12 min de reloj, colapso de ráfagas densas, baseline mediana) — ver `estrateia_lectura_gas_cliente.md` y `ethyleneIdleAnomalySanitize.ts`.
